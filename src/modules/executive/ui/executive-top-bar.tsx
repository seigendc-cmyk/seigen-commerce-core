    ...
    <header className="executive-panel border-b border-white/10 px-4 py-4 sm:px-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <span className="rounded-full border border-teal-500/30 bg-teal-600/10 px-2.5 py-1 text-[11px] font-semibold text-teal-600">
            local-first
          </span>
          <Link
            href="/dashboard"
            className="rounded-lg border border-white/15 px-3 py-2 text-xs font-semibold text-neutral-200 hover:border-teal-500/60 hover:text-white"
          >
            Vendor dashboard
          </Link>
          <Link
